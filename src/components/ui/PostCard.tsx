  ...
  return (
    <div className="">
      <div className="flex justify-center ">
        ...
        >
          <div className="w-full h-full bg-[#ffffff1f]">
            <Link href={`/detail/${post._id}`}>
              <video
                loop
                muted
            ...
            <div className="w-full absolute bottom-0 z-20 bg-gradient-to-t from-black p-5">
              ...
              >
                ...
                <button
                  ...
                  className={`flex justify-end text-copy-light text-sm font-normal leading-tight`}
                >
              ...
              {isHover && (
                <div className="py-1 flex items-center justify-between">
                  <button className="" onClick={onVideoPress}>
                    {playing ? (
                  ...
                  <button className="" onClick={onVideoMoted}>
                    {isVideoMuted ? (
        ...
        <div className="w-16">
          <ul className="h-full flex flex-col items-center justify-end gap-4">
            <li className="w-12 h-12 bg-white rounded-full relative">
              <Link href="/">
                <Image
